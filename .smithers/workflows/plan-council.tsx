...
const DEFAULT_CONCEPT_PATH =
  "docs/investigations/fff-pass-through/2026-07-16-code-mode-synthesis.md";
const PLAN_COUNCIL_DIR = "docs/investigations/fff-pass-through/plan-council";
const MATERIALIZED_CONCEPT_PATH = `${PLAN_COUNCIL_DIR}/input-concept.md`;
const PLAN_PREFIX = "2026-07-16-";
const PLAN_SLUG = "feat-fff-two-lane-architecture-plan";
