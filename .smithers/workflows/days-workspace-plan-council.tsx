...
const DEFAULT_CONCEPT_PATH =
  "docs/plans/2026-07-20-001-feat-days-workspace-filters-plan.md";
const PLAN_COUNCIL_DIR =
  "docs/investigations/cm-decoupling/plan-council-days-workspace";
const MATERIALIZED_CONCEPT_PATH = `${PLAN_COUNCIL_DIR}/input-concept.md`;
const PLAN_PREFIX = "2026-07-20-";
const PLAN_SLUG = "feat-days-workspace-filters-plan";
...
export default smithers((ctx) => {
  ...
  return (
    <Workflow name="days-workspace-plan-council">
      <Sequence>
        <Task
          id="resolve-concept"
