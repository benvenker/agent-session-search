...
// smithers-display-name: Code Mode Plan Council
...
import PlanDraftPrompt from "../prompts/code-mode-plan-draft.mdx";
import PlanReviewPrompt from "../prompts/code-mode-plan-review.mdx";
import PlanRevisePrompt from "../prompts/code-mode-plan-revise.mdx";
import PlanSynthesisPrompt from "../prompts/code-mode-plan-synthesis.mdx";

const DEFAULT_CONCEPT_PATH =
  "docs/investigations/code-mode/plan-council/input-concept.md";
const PLAN_COUNCIL_DIR = "docs/investigations/code-mode/plan-council";
const MATERIALIZED_CONCEPT_PATH = `${PLAN_COUNCIL_DIR}/input-concept.md`;
const PLAN_PREFIX = "2026-07-18-";
const PLAN_SLUG = "feat-session-search-code-plan";
...
export default smithers((ctx) => {
  ...
  return (
    <Workflow name="code-mode-plan-council">
      <Sequence>
        <Task
          id="resolve-concept"
