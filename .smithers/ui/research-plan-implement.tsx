    ...
    <div className="panel" data-testid={props.testId}>
      <div className="panel-head" onClick={() => setOpen((o) => !o)}>
        <div className="left">
          <h2>{props.title}</h2>
          {props.badge ? (
            <span className={"badge " + props.badge.cls}>
              {props.badge.text}
            </span>
          ) : null}
        </div>
      ...
      {open ? (
        <div className="panel-body">
          {props.pending ? (
            <div className="muted">{props.pendingText}</div>
          ) : (
            props.children
          )}
        </div>
...
function App() {
  ...
  const researchOut = useGatewayNodeOutput({
    runId: activeRunId,
    nodeId: "research",
    iteration: 0,
  });
  const planOut = useGatewayNodeOutput({
    runId: activeRunId,
    nodeId: "plan",
    iteration: 0,
  });
  ...
  const research = useMemo(
    () => extractResearch(researchOut.data),
    [researchOut.data]
  );
    ...
    <main className="shell" data-testid="research-plan-implement-ui">
      ...
      <header className="topbar">
        <div className="title-group">
          ...
          {activeRun ? (
            <span className={"badge " + statusClass(activeRun.status)}>
        ...
        <div className="toolbar">
          ...
          <label className="check">
            <input
              type="checkbox"
              checked={tdd}
              onChange={(e) => setTdd(e.currentTarget.checked)}
            />{" "}
            TDD
          </label>
          <button
        ...
        <div className="content">
          {!activeRunId ? (
            <div
              ...
              data-testid="research-plan-implement-empty"
            >
              <h2>Launch a workflow</h2>
              <p>
                Describe the change. Research informs the plan, then an
                implement → validate → review loop runs until reviewers approve.
              </p>
              <input
                className="prompt"
                value={prompt}
            ...
            <>
              ...
              <div className="stage">
                ...
                {blockingFeedback ? (
                  <div
                    ...
                    data-testid="research-plan-implement-feedback"
                  >
                        ...
                        <div className="reviewer-card">
                          ...
                          {review.issues.length > 0 ? (
                            <div className="sev-row">
                              ...
                              <span className="sev major">
                                major {sevCount("major")}
                              </span>
                              <span className="sev minor">
              ...
              <div className="stage">
                ...
                <div
                  className="gate"
                  data-testid="research-plan-implement-gate"
                >
