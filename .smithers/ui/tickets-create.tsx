...
function App() {
  ...
  const result = useMemo(
    () => extractTickets(ticketsOutput.data),
    [ticketsOutput.data]
  );
        ...
        <div className="title-group">
          ...
          {activeRun ? (
            <span
              ...
              data-testid="tickets-create-status"
            >
          ...
          {result ? (
            <>
              <div
                ...
                data-testid="tickets-create-summary-panel"
              >
                <h2>Breakdown summary</h2>
                <div
                  className="summary-text"
                  data-testid="tickets-create-summary"
                >
                  {result.summary}
                </div>
              </div>
              ...
              {result.tickets.length > 0 ? (
                <div className="tickets" data-testid="tickets-create-tickets">
                  {result.tickets.map((ticket, i) => (
                    <article
                      ...
                      data-testid="tickets-create-ticket"
                      key={i}
                    >
                ...
                <div
                  className="empty"
                  data-testid="tickets-create-tickets-empty"
                >
                ...
                {events.length > 0 ? (
                  events.slice(-30).map((ev, i) => (
                    <div className="event-line" key={i}>
                      {asString((ev as Record<string, unknown>).type) ??
                        "event"}
                    </div>
                  ))
                ) : (
