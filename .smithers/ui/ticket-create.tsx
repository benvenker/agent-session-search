...
function App() {
  ...
  const [prompt, setPrompt] = useState(
    "Create a ticket for the requested work."
  );
  ...
  const ticketOutput = useGatewayNodeOutput({
    runId: activeRunId,
    nodeId: "ticket",
    iteration: 0,
  });
  const ticket = useMemo(
    () => extractTicket(ticketOutput.data),
    [ticketOutput.data]
  );
    ...
    <main className="shell" data-testid="ticket-create-ui">
      ...
      <header className="topbar">
        <div className="title-group">
          ...
          {activeRun ? (
            <span
              ...
              data-testid="ticket-create-status"
            >
        ...
        <div className="toolbar">
          ...
          <button
            className="button"
            data-testid="ticket-create-refresh"
        ...
        <div className="content">
          <div className="col">
            ...
            <div
              ...
              data-testid="ticket-create-generation-status"
            >
              {running ? (
                <span className="badge running">Generating…</span>
              ) : null}
              {!running && ticket ? (
                <span className="badge finished">Ready</span>
              ) : null}
              {failed ? <span className="badge failed">Failed</span> : null}
              <span className="status-msg">
                {eventCount} events
                {ticketOutput.loading ? " · refreshing…" : ""}
              </span>
            </div>
              ...
              <div className="ticket-card" data-testid="ticket-create-card">
                <div className="ticket-head">
                  ...
                  <button
                    ...
                    onClick={() => copyText(ticketMarkdown(ticket))}
                  >
                    Copy all
                  </button>
                </div>
                ...
                <div className="ticket-section">
                  <h3>
                    ...
                    <button
                      className="button tiny"
                      onClick={() => copyText(ticket.description)}
                    >
                      Copy
                    </button>
                  </h3>
                ...
                <div
                  ...
                  data-testid="ticket-create-acceptance"
                >
                  ...
                  {ticket.acceptanceCriteria.length > 0 ? (
                      ...
                      {ticket.acceptanceCriteria.map((c, i) => {
                        ...
                        return (
                          <li key={i} data-testid="ticket-create-criterion">
                            ...
                            <span
                              className={"ac-text" + (checked ? " done" : "")}
                            >
                              {c}
                            </span>
                          </li>
                    ...
                    <div className="ac-empty">
                      No acceptance criteria were generated for this ticket.
                    </div>
                  )}
                </div>
              ...
              <div className="empty" data-testid="ticket-create-empty">
                {failed ? (
                  ...
                  <>
                    ...
                    <div>
                      The agent is turning the request into a structured ticket.
                    </div>
                  </>
                ) : (
                  <>
                    <h2>No ticket yet</h2>
                    <div>
                      Describe the work you want captured and generate a ticket.
                    </div>
                    <div className="form">
                      <textarea
